                  ...
                  <TableBody>
                    {(results || []).filter(Boolean).map((result) => (
                      <TableRow key={result._id}>
                        <TableCell>{(Array.isArray(exams) ? exams : []).find((e) => e.examId === result.examId || e._id === result.examId)?.examName || result.examId}</TableCell>
                        <TableCell>
                          <Chip
                ...
                <TableBody>
                  {(filteredResults || []).filter(Boolean).map((result) => (
                    <TableRow key={result._id}>
                      ...
                      <TableCell>
                        {(Array.isArray(exams) ? exams : []).find((e) => e.examId === result.examId || e._id === result.examId)?.examName || result.examId}
                      </TableCell>
                      <TableCell>
                        <Chip
                          label={`${(result.percentage || 0).toFixed(1)}%`}
